      ...
      <div className="mt-6 flex flex-col">
        <div className="flex justify-between items-center pb-5 border-b border-zinc-200">
          ...
          <div className="flex items-center gap-2">
            <button className="rounded-lg px-4 py-2 font-semibold shadow-sm border border-zinc-300 text-zinc-700 hover:bg-zinc-50" type="button">Cancel</button>
            <button className="rounded-lg px-4 py-2 font-semibold shadow-sm bg-violet-600 text-white hover:bg-violet-700" type="submit" form="settings" >Save</button>
          </div>
        </div>
        <form id="settings" action="" className="mt-6 flex flex-col w-full gap-5 divide-y divide-zinc-200">
          <div className="grid grid-cols-form gap-3">
            <label htmlFor="firsName" className="text-sm font-medium text-zinc-700">
              Name
            </label>
            <div className="grid gap-6 grid-cols-2">
                <Input.Root>
                  <Input.Control placeholder="First name" id="firstName" defaultValue="John" />
                </Input.Root>
                <Input.Root>
                  <Input.Control placeholder="Last name" id="lastName" defaultValue="Everton" />
                </Input.Root>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            <label htmlFor="email" className="text-sm font-medium text-zinc-700">
              ...
              <Input.Root>
                ...
                <Input.Control placeholder="Email" id="email" type="email" defaultValue="johneverton44@gmail.com" />
              </Input.Root>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <div className="flex items-start gap-5">
              ...
              <label htmlFor="photo" className="group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm hover:bg-violet-25 hover:border-violet-200 hover:text-violet-500">
          ...
          <div className="flex items-center justify-end gap-2 pt-5">
            <button className="rounded-lg px-4 py-2 font-semibold shadow-sm border border-zinc-300 text-zinc-700 hover:bg-zinc-50" type="button">Cancel</button>
            <button className="rounded-lg px-4 py-2 font-semibold shadow-sm bg-violet-600 text-white hover:bg-violet-700" type="submit"  >Save</button>
          </div>
        </form>
      </div>
    </>
